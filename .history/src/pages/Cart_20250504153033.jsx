        ...
        >
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-sm text-white font-bold ">{product.description}</p>
            </div>
          </div>
          ...
          <div className="text-right text-white">
            ...
            <button onClick={() => dispatch(increment({ id: product.id }))} className='text-2xl'>+</button>
            <button onClick={()=>dispatch (decrement({ id: product.id }))} className='text-2xl'>-</button>
               </div>
