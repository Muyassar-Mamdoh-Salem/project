...
const handleSubmit=(e)=>{
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-300  px-6 py-12">
      <div className="relative max-w-md w-full bg-gradient-to-tr from-black/70 to-gray-800/70 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-32 h-32 bg-purple-300 rounded-tl-full opacity-40 animate-pulse -z-10"></div>
        ...
        <div className="px-10 py-12">
          ...
          <p className="text-center text-gray-100 mb-8 font-semibold tracking-wide">
            Already have an account?{" "}
            <Link
              to="/sign"
              className="text-indigo-200 hover:text-indigo-200 transition font-bold underline"
            >
              Sign in
            </Link>
          </p>
          ...
          <div className="flex flex-col gap-5 mb-10">
            <button className="flex items-center justify-center gap-3 py-3 rounded-xl bg-indigo-300 text-white font-semibold shadow-lg hover:bg-indigo-200 transition">
              <img
          ...
          <form className="space-y-6">
            {formFields.map(({ Icon , placeholder, type, name }) => (
              <div
                key={name}
                className="flex items-center gap-4 bg-gray-400 bg-opacity-60 rounded-xl shadow-inner px-4 py-3 backdrop-blur-md border border-indigo-600 hover:border-indigo-400 transition"
              >
