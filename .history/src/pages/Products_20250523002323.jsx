...
const Products = () => {
 ...
 return (
  <div className="min-h-screen bg-gray-50 py-8 px-4 max-w-full overflow-x-hidden sm:w-10">
    <h2 className="text-3xl font-bold text-center text-purple-700 mb-8">Our Products</h2>

    <motion.div
      className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-full"
      ...
      {products.map((product) => (
        ...
        >
          ...
          <Link to={`/product/${product.id}`}>
           <button className="w-full bg-purple-500 text-white py-2 rounded-lg hover:bg-purple-600 transition sm:w-[180px] md:w-[220px] lg:w-[280px]">
