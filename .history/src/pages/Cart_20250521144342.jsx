      ...
      <div className="flex flex-col items-center gap-6">
        {products.map((product) => {
          ...
          return (
            <div
              key={product.id}
              className="w-full max-w-[250px] sm:max-w-2xl flex flex-col sm:flex-row items-center justify-between gap-4 bg-gradient-to-r from-purple-600 to-blue-500 p-4 rounded-xl shadow-lg"
            >
              {/* Image + info */}
