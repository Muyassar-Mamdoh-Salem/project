        ...
        <div className="px-10 py-12">
          ...
          <form className="space-y-6">
            {formFields.map(({ Icon , placeholder, type, name }) => (
              <div
                key={name}
                className="flex items-center gap-4 bg-gray-00 bg-opacity-60 rounded-xl shadow-inner px-4 py-3 backdrop-blur-md border border-indigo-600 hover:border-indigo-400 transition"
              >
