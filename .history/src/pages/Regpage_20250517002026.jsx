 ...
 *
 * This component renders a registration form with Googimport React from "react";
import {
  User,
  Mail,
  Phone,
 ...
 * The Register page component.
 *
 * This component renders a registration form with Google and Facebook
 * sign-up buttons, as well as a form to input first name, last name, email,
 * phone number, address, password, and confirm password.
 *
 * The component also includes a link to the terms and privacy policy pages.
 *
 * @returns {JSX.Element} The Register page component.
 */
const Regpage = () => {
  // مصفوفة الحقول جاهزة للاستخدام في الفورم
  const formFields = [
      ...
      <div className="relative max-w-md w-full bg-gradient-to-tr from-black/70 to-gray-800/70 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-10 py-12">
          ...
          <p className="text-center text-gray-300 mb-8 font-semibold tracking-wide">
            ...
            <Link
              to="/sign"  // عدل هذا الرابط حسب صفحة تسجيل الدخول عندك
          ...
          <form className="space-y-6">
            {formFields.map(({ Icon, placeholder, type, name }) => (
              <div
                key={name}
 ...
 * @returns {JSX.Element} The Register page component.
 */
const Regpage = () =>   const formFields = 
  
  {
  [


    { Icon: UserIcon, placeholder: "First Name", type: "text", name: "firstName" },
    { Icon: UserIcon, placeholder: "Last Name", type: "text", name: "lastName" },
    { Icon: MailIcon, placeholder: "Email address", type: "email", name: "email" },
    { Icon: PhoneIcon, placeholder: "Phone Number", type: "tel", name: "phone" },
    { Icon: MapPinIcon, placeholder: "Address", type: "text", name: "address" },
    { Icon: LockIcon, placeholder: "Password", type: "password", name: "password" },
    { Icon: LockIcon, placeholder: "Confirm Password", type: "password", name: "confirmPassword" },
  ];
      ...
      <div className="relative max-w-md w-full bg-gradient-to-tr from-black/70 to-gray-800/70 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-10 py-12">
          ...
          <p className="text-center text-gray-300 mb-8 font-semibold tracking-wide">
            Already have an account?{" "}
            <Link
              to="/sign"  // Replace with your sign-in page route
              // عدل هذا الرابط حسب صفحة تسجيل الدخول عندك
              className="text-indigo-400 hover:text-indigo-200 transition font-bold underline"
            >
              Sign in
            </Link>
