        ...
        {products.map((product) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 right-3 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:text-red-500 bg-white rounded-full p-1 shadow-md"
            >
