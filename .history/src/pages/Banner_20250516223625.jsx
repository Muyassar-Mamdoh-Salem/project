      ...
      <Swiper className="mySwiper">
        <SwiperSlide>
          <div className="relative w-full h-[400px]">
            ...
            <div className='absolute top-1/2 left-1 transform -translate-x-1/2 -translate-y-1/2 text-center text-white px-4'>
              <h2 className="text-5xl font-bold mb-2">Summer Collection 2023</h2>
              <p className="mb-4">Discover our new arrivals with up to 30% off on selected items</p>
