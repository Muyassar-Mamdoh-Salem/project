        ...
        {products.map((product) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <Link to="cart"><button onClick={dispatch{add}}className="bg-blue-500 text-white text-sm px-3 py-1 rounded hover:bg-blue-600 transition">Add to cart</button></Link>
            </div>
