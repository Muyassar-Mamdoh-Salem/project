...
const Products = () => {
    ...
    return (
        ...
        {products.map((product) => (
          <div key={product.id} className="w-10 sm:w-1/2 md:w-1/3 lg:w-1/4 p-4 shadow-lg hover:shadow-xl transition-shadow duration-300 grid sm-cols-12 md:grid-cols-2 lgcols-3">
