          ...
          <div key={product.id} className="w-10 sm:w-1/2 md:w-1/3 lg:w-1/4 p-4 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <ul className="list-none ">
              <li   className="w-[200px] h-auto mb-2 transform transition-transform duration-300 hover:scale-105">
                ...
                <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 active: z bg-blue-800 transition-transform duration-150">Add to cart</button>
              </li>
            </ul>
          </div>
