...
<h2 className="text-2xl font-bold"><span className="text-blue-600">Shop</span> Ease</h2>          
          ...
          <div className="flex justify-end items-center space-x-4">
            ...
            <div className="hidden md:flex space-x-4 text-xl text-gray-700">
              <HashLink to="/login" className="hover:text-blue-500 cursor-pointer transition duration-300"><FaUser className="hover:text-blue-500 cursor-pointer transition duration-300" />
