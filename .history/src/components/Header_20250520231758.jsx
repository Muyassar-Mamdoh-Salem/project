      ...
      <header className="bg-gray-200 shadow-md fixed top-0 left-0 right-0 z-30">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-4 px-4 py-3">
          ...
          <div className="flex justify-center w-full">
            <div className="flex items-center w-full mr-20 max-w-md">
              <input
                type="text"
          ...
          <div className="flex justify-end items-center space-x-4">
            ...
            <nav className="hidden md:flex space-x-6 text-lg">
              ...
              <HashLink to="/shop" className="hover:text-blue-500 transition duration-300 md:hidden:md">Shop</HashLink>
              <HashLink to="/categories" className="hover:text-blue-500 transition duration-300 md:hidden">Categories</HashLink>
              <HashLink smooth to="#footer" className="hover:text-blue-500 transition duration-300 ">About</HashLink>
            </nav>
