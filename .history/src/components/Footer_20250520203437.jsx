    ...
    <div className='bg-slate-900 '>
      ...
      <section className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4 py-10 bg-slate-900 text-white container mx-auto '>
        ...
        <div><h3>Newsletter</h3>
          ...
          <div className='flex items-center '><input type="email" placeholder='Enter your email' className='' /><button className='bg-blue-800 text-white p-2'>Subscribe</button></div>
        </div>
