    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-around py-5 text-white mt-12 border-b border-gray-600">
          ...
          {UserInfo &&(<span><FaSignOutAlt />
          <button onClick={handleSignOut} className="text-sm font-semibold text-white hover:text-yellow-400 transition duration-300">Logout</button> </span>) }
