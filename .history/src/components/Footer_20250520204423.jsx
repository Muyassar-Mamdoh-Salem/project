  ...
  return (
    <div className='bg-slate-900 '>
      <footer className=' text-white  gap-4 grid grid-cols-2 container mx-auto md:grid-cols-4 py-10 '>
        ...
        <div className='flex' ><h3>Free Shipping</h3><p className='opacity-70'>On orders over $50</p>
<AiFillTruck className='text-2xl text-blue-600 flex' />
          <div className='mt-16 '>
        ...
        <div><h3>Secure Payment</h3><p className='opacity-70'>100% secure checkout</p>
