    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-around py-5 text-white mt-12 border-b border-gray-600">
          <FaUser className="text-xl hover:text-yellow-400 cursor-pointer transition duration-300" />
          <HashLink to="/cart" onClick={() => setOpenBar(false)} className="relative">
            <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
              {totalItems}
            </span>
            <FaShoppingCart className="text-xl hover:text-yellow-400 cursor-pointer transition duration-300" />
          </HashLink>
          <MdFavoriteBorder className="text-xl hover:text-yellow-400 cursor-pointer transition duration-300" />
        </div>
