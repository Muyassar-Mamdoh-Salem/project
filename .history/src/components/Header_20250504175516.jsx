  ...
  return (
    <>
      ...
      <div
        ...
        } transition-transform duration-500 ease-in-out z-50 bg-gradient-to-b from-blue-900 via-blue-800 to-gray-900`}
      >
        {/* Close Button */}
        <div
        ...
        <div className="flex items-center justify-around py-5 text-white mt-12 border-b border-gray-600">
          <FaUser className="text-xl hover:text-yellow-400 cursor-pointer" />
          <HashLink to="/cart" onClick={() => setOpenBar(false)} className="relative">
            <span className="absolute -top-2 -right-2 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
              {totalItems}
            </span>
            <FaShoppingCart className="text-xl hover:text-yellow-400 cursor-pointer" />
          </HashLink>
          <MdFavoriteBorder className="text-xl hover:text-yellow-400 cursor-pointer" />
        </div>
