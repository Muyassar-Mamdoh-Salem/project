        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-4 px-4 py-3">
          ...
          <div className="flex justify-end items-center space-x-4">
            ...
            <nav className="hidden md:flex space-x-6 text-lg">
              ...
              <HashLink to="/shop" className="hover:text-blue-500 transition duration-300 hidden:md">Shop</HashLink>
              <HashLink to="/categories" className="hover:text-blue-500 transition duration-300 hidden:md">Categories</HashLink>
