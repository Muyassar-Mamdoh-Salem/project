...
const ProductDetails = () => {
  ...
  return (
    <div className="p-4 bg-purple-100 vh-100   space-y-6">
      <h2 className="text-2xl font-bold" >{product.title}</h2>
      <img className="w-40" src={product.image} alt={product.title} />
      <p><Details></Details>{product.description}</p> 
      ...
      <button className="border-2 rounded-lg p-3 bg-orange-400 active:bg-orange-600 transform-transition duration-150">Buy Now</button> 
      </div>
    </div>
  );
};
