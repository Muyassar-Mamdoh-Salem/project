...
import { AiFillTruck ,AiFillCreditCard ,AiFillSafetyCertificate ,AiOutlineQuestionCircle } from 'react-icons/ai' 
...
<div>
        ...
        <div>
          <div className='flex items-center gap-4' >
            <AiFillSafetyCertificate className='text-2xl text-blue-600' />
<div>
          <h3>Quality Guarantee</h3>
          <p className='opacity-70'>Product quality assured</p>
          </div>
</div>
          <div className='mt-16 '>
        ...
        <div >
<div className='flex items-center gap-4'>
            <AiOutlineQuestionCircle className='text-2xl text-blue-600' />

          <h3>24/7 Support</h3><p className='opacity-70'>Dedicated support</p>
        </div>
          ...
          <div className='flex items-center mt-5 '>
            <input type="email" placeholder='Enter your email' className='p-2' /><button className='bg-blue-800 text-white p-2'>Subscribe</button></div>
        </div>
        </div>
