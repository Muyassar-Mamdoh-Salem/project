  ...
  return (
    <div className='bg-slate-900 '>
      <footer className=' text-white  gap-4 grid grid-cols-2 container mx-auto md:grid-cols-4 py-10 '>
        ...
        <div><h3>Secure Payment</h3><p>100% secure checkout</p>
        ...
        <div><h3>Quality Guarantee</h3><p>Product quality assured</p>
        ...
        <div ><h3>24/7 Support</h3><p>Dedicated support</p>
        
          <div className=''><h3>Newsletter</h3>
          <p>Subscribe to get updates on new arrivals, special offers and other discount information.</p>
          <div className='flex items-center mr-16 '><input type="email" placeholder='Enter your email' className='p-2' /><button className='bg-blue-800 text-white p-2'>Subscribe</button></div>
        </div>
        </div>
