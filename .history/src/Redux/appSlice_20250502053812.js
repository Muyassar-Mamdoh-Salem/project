 ...
 * @param {Object} action.payload - The product information.
 * @param {number} action.payload.id - The ID of the product to add or update.
 * @param {number} action.payload.quantity - The quantity to add to the cart.
 */
